    ...
    function O(e, t, n) {
      return (
        ...
        (function (e) {
          ...
          for (t in e)
            e.hasOwnProperty(t) &&
              ((n = e[t]), r.push(t + '=' + ('start_track' === t ? parseInt(n, 10) : n ? 'true' : 'false')))
          return r.join('&')
        })(n)
      )
    }
    ...
    function A(e) {
      ...
      return (
        ...
        (!t || P(e.origin) === P(t.domain)) &&
          (t
            ? (r === s.READY && ((t.isReady = !0), w(t, '__LATE_BINDING__'), h('__LATE_BINDING__', t)),
              r !== s.PLAY || t.playEventFired || (t.playEventFired = !0),
              r !== s.PLAY_PROGRESS || t.playEventFired || ((t.playEventFired = !0), w(t, s.PLAY, [o])),
              (i = []),
              void 0 !== o && i.push(o),
              void w(t, r, i))
    ...
    window.addEventListener ? window.addEventListener('message', A, !1) : window.attachEvent('onmessage', A),
      (e.exports = i =
        function (e, t, n) {
          var i
          if (
            (('' === (i = e) || (i && i.charCodeAt && i.substr)) && (e = document.getElementById(e)),
            !(function (e) {
